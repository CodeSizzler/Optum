...
1. On the **Resource group** page, check the resource group listed or create a new resource group in the name of Contoso-rg, make note of the **Location** assigned to your resource group, as you will use it in the next exercise.

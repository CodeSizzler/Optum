...
CodeSizzler wants to migrate their existing Azure VMs to another region
...
1. From the Cloud Shell pane, upload the Azure Resource Manager template **\\allfiles\\azuredeploy06.json** into the home directory.

1. From the Cloud Shell pane, upload the parameter file **\\allfiles\\azuredeploy06.parameters.json** into the home directory.

---
lab:
    title: 'Whitepaper discussion – Backup to URL and Restore from URL'
...
1. Download the database backup file located on **OneDrive** to **C:\LabFiles\HADR** path on the lab virtual machine (create the folder structure if it does not exist).
